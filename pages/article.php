      ...
      <main class="container pt-3 main">
          ...
          <?php
            if (isset($_GET["id"])) {
                ...
                $userid = $mysqli->real_escape_string($_GET["id"]);
                $sql = "SELECT * FROM `lq_articles` WHERE id = '$userid'";
            ...
            ?>
                          ...
                          <nav aria-label=" breadcrumb">
                              <ol class="breadcrumb">
                                  ...
                                  <li class="breadcrumb-item active" aria-current="page"><?php print_r($name); ?></li>
                              </ol>
                          </nav>
                          <div>
                              <h2 class="text-center pb-3"><?php echo $name; ?></h2>
                          </div>
