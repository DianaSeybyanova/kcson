  ...
  <head>
      ...
      <meta name="description" content="КЦСОН | Материалы" />
      ...
      <main class="container pt-3 main">
          ...
          <?php
            if (isset($_GET["id"])) {
                ...
                $sql = "SELECT * FROM `lq_pages` WHERE id = '$id'";
            ...
            ?>
                          ...
                          <nav aria-label=" breadcrumb">
                              <ol class="breadcrumb">
                                  ...
                                  <li class="breadcrumb-item"><a href="/pages/services.php">Материалы</a></li>
